...
gr_s1_3000 = ROOT.TGraph(len(xvals), array('d', xvals), array('d', yvals_s1))
gr_s2_3000 = ROOT.TGraph(len(xvals), array('d', xvals), array('d', yvals_s2))
gr_s1_300 = ROOT.TGraph(len(xvals), array('d', xvals), array('d', yvals_s1_300))
gr_s2_300 = ROOT.TGraph(len(xvals), array('d', xvals), array('d', yvals_s2_300))
